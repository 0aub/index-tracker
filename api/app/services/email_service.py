...
class EmailService:
    ...
    def send_welcome_email(
        ...
        """
        subject = "مرحباً بك في منصة ساهم - Welcome to Sahem Platform"
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>تم إنشاء حساب جديد لك في منصة ساهم. يمكنك الآن الدخول إلى المنصة باستخدام بيانات الاعتماد التالية:</p>
        ...
        # Plain text body
        body_text = f"""
مرحباً بك في منصة ساهم
المنصة الذكية لإدارة المؤشرات

عزيزي/عزيزتي {user_name_ar}،

تم إنشاء حساب جديد لك في منصة ساهم.

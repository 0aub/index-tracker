...
import { Layers, Plus, Edit, Trash2, CheckSquare, CheckCircle2, TrendingUp, AlertCircle, FileText, GitBranch } from 'lucide-react';
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-20">
        <LoadingSpinner size="md" text={lang === 'ar' ? 'جاري تحميل المؤشرات...' : 'Loading indices...'} />
      </div>
    );
  }
